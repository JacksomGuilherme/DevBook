...
// BuscarSeguindo traz todos os usuários que o usuário está seguindo
func BuscarSeguindo(w http.ResponseWriter, r *http.Request) {
	...
	usuariosSeguidos, erro := repositorio.BuscarSeguindo(usuarioID)
	if erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possível alterar a senha de um usuário que não seja o seu"))
		return
	}
