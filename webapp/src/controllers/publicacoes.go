...
// CurtirPublicacao chama a API para curtir uma publicação no banco de dados
...
// DescurtirPublicacao chama a API para descurtir uma publicação no banco de dados
...
// AtualizarPublicacao chama a API para atualizar uma publicação no banco de dados
...
// DeletePublicacao chama a API para deletar uma publicação do banco de dados
